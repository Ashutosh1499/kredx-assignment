...
import homeBackground from '@/public/assets/images/home-background.png';
...
function HomeLandingPage() {
	return (
		<section
			...
			<Image alt='' src={kredCMSLogo} id='kredCMSLogo' className='col-span-3' />
			<div
